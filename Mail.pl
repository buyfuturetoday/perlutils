...
Mail - Accepts all required parameters and sends a mail to list of recipients.
...
This application attempts to send mail messages to list of recipients. It is a wrapper for the Mail.pm module.

=head1 SYNOPSIS

Mail.pl [-t] [-l log_dir] -d recipients [-s smtp_server] -o sender -m message [-u subject] [-p]
