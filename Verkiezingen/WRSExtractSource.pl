...
WRSExtractSource.pl - Script to extract Source data from the CAUM4WS table for all transactions.
...
=head1 SYNOPSIS
 ...
 WRSExtractSource.pl [-t] [-l log_dir] [-d datasource] -i instancenumber

    WRSExtractSource.pl -h	  Usage
    WRSExtractSource.pl -h 1    Usage and description of the options
    WRSExtractSource.pl -h 2    All documentation
...
# Open Output file
my $outfile = $rep_dir."/source_$identifier.html";
